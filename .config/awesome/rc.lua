...
globalkeys = gears.table.join(
  ...
  -- Prompt
  awful.key({ modkey }, "r", function() awful.util.spawn("rofi -show combi -combi-modi \"drun,run\" -modi combi") end,
    { description = "runs rofi drun", group = "launcher" }),
  ...
  awful.key({ modkey }, "p", function() awful.util.spawn("rofi -show window") end,
    { description = "runs rofi window", group = "launcher" })
)
...
clientkeys = gears.table.join(
  ...
  awful.key({ modkey, }, "h", function(c) c:move_to_screen() end,
